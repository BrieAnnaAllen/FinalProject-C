...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CurrentGun_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_CurrentGun;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGranadeLauncherTestProjectile_OnHit, "OnHit" }, // 77168296
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::NewProp_CurrentGun_MetaData[] = {
		{ "Category", "Projectile" },
		{ "ModuleRelativePath", "GranadeLauncherTestProjectile.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::NewProp_CurrentGun = { UE4CodeGen_Private::EPropertyClass::Int, "CurrentGun", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(AGranadeLauncherTestProjectile, CurrentGun), METADATA_PARAMS(Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::NewProp_CurrentGun_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::NewProp_CurrentGun_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGranadeLauncherTestProjectile_Statics::NewProp_CurrentGun,
	...
	IMPLEMENT_CLASS(AGranadeLauncherTestProjectile, 3897441262);
