...
void AGranadeLauncherTestCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AGranadeLauncherTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AGranadeLauncherTestCharacter::OnResetVR);

	// Bind movement events
	PlayerInputComponent->BindAxis("MoveForward", this, &AGranadeLauncherTestCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AGranadeLauncherTestCharacter::MoveRight);
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AGranadeLauncherTestProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AGranadeLauncherTestProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AGranadeLauncherTestCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AGranadeLauncherTestCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AGranadeLauncherTestCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AGranadeLauncherTestCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
void AGranadeLauncherTestCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AGranadeLauncherTestCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AGranadeLauncherTestCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AGranadeLauncherTestCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AGranadeLauncherTestCharacter::TouchUpdate);
		return true;
	}
